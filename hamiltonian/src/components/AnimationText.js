...
export const AnimationText1 = () => {
  return (
    <Fragment>
      <TypeAnimation
        cursor={true}
        sequence={[" Backward Completion", 1000, " O(log N) Navigation", 1000, " Partition Coordinates", 1000]}
        wrapper="span"
        repeat={Infinity}
      />
    </Fragment>
...
const skills = ["Backward Completion", "O(log N) Navigation", "Partition Coordinates"];
